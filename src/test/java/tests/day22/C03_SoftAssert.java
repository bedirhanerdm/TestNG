...
public class C03_SoftAssert extends TestBaseCross {
    ...
    public void test01() {
        ...
        softAssert.assertTrue(driver.getTitle().contains("aAmazon"), "Girdiginiz kelimeyi icermiyor");
        ...
        softAssert.assertTrue(sonuc.getText().contains("nautella"), "Sonuc Nutella icermiyor");
